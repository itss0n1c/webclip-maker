    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$2, 100, 16, 3736);
    			add_location(p, file$2, 100, 3, 3723);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$2, 95, 3, 3600);
    			add_location(br1, file$2, 95, 9, 3606);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section0, "class", "header svelte-15wa1ro");
    			add_location(section0, file$3, 16, 1, 308);
    			add_location(p, file$3, 20, 2, 383);
    			attr_dev(div0, "class", "button svelte-15wa1ro");
    			add_location(div0, file$3, 21, 2, 461);
    			attr_dev(section1, "class", "svelte-15wa1ro");
    			add_location(section1, file$3, 19, 1, 371);
    			attr_dev(div1, "class", "modal-overlay svelte-15wa1ro");
    			div1.hidden = div1_hidden_value = !/*showModal*/ ctx[2];
    			add_location(div1, file$3, 23, 1, 532);
    			attr_dev(div2, "class", "svelte-15wa1ro");
    			add_location(div2, file$3, 26, 3, 683);
    			attr_dev(div3, "class", "red svelte-15wa1ro");
    			add_location(div3, file$3, 27, 3, 748);
    			attr_dev(div4, "class", "buttons svelte-15wa1ro");
    			add_location(div4, file$3, 25, 2, 658);
    			attr_dev(div5, "class", div5_class_value = "modal " + (/*showModal*/ ctx[2] ? "show" : "") + " svelte-15wa1ro");
    			add_location(div5, file$3, 24, 0, 610);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div1, "click", /*closeProfile*/ ctx[4], false, false, false),
    					listen_dev(
    						div2,
    						"click",
    						function () {
    					...
    					listen_dev(div3, "click", /*closeProfile*/ ctx[4], false, false, false)
    				];
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (!current || dirty & /*showModal*/ 4 && div5_class_value !== (div5_class_value = "modal " + (/*showModal*/ ctx[2] ? "show" : "") + " svelte-15wa1ro")) {
