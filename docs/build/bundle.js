...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			input.required = true;
    			add_location(input, file$1, 21, 2, 523);
    			...
    			add_location(img, file$1, 22, 2, 640);
    			attr_dev(div, "class", "icon svelte-1qmhx7o");
    			add_location(div, file$1, 20, 1, 482);
    			add_location(main, file$1, 19, 0, 474);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (70:6) <EntryCell title="Web App Settings" on:message={handleCell} cellid={index}>
    function create_default_slot(ctx) {
    	...
    	function input0_input_handler_1() {
    		/*input0_input_handler_1*/ ctx[11].call(input0, /*index*/ ctx[21]);
    	}

    	function iconhandler_icon_binding(value) {
    		/*iconhandler_icon_binding*/ ctx[12].call(null, value, /*index*/ ctx[21]);
    	}

    	let iconhandler_props = { index: /*index*/ ctx[21] };

    	if (/*config*/ ctx[1].webclips[/*index*/ ctx[21]].iconurl !== void 0) {
    		iconhandler_props.icon = /*config*/ ctx[1].webclips[/*index*/ ctx[21]].iconurl;
    	}
    	...
    	iconhandler.$on("message", /*handleIcon*/ ctx[6]);

    	function input1_input_handler_1() {
    		/*input1_input_handler_1*/ ctx[13].call(input1, /*index*/ ctx[21]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$2, 70, 7, 2172);
    			attr_dev(input1, "type", "url");
    			attr_dev(input1, "name", input1_name_value = "url[" + /*index*/ ctx[21] + "]");
    			attr_dev(input1, "placeholder", "URL");
    			input1.required = true;
    			add_location(input1, file$2, 72, 7, 2394);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input0, anchor);
    			set_input_value(input0, /*config*/ ctx[1].webclips[/*index*/ ctx[21]].name);
    			insert_dev(target, t0, anchor);
    			mount_component(iconhandler, target, anchor);
    			insert_dev(target, t1, anchor);
    			insert_dev(target, input1, anchor);
    			set_input_value(input1, /*config*/ ctx[1].webclips[/*index*/ ctx[21]].url);
    			current = true;
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*config*/ 2 && input0.value !== /*config*/ ctx[1].webclips[/*index*/ ctx[21]].name) {
    				set_input_value(input0, /*config*/ ctx[1].webclips[/*index*/ ctx[21]].name);
    			}
    			...
    			if (!updating_icon && dirty & /*config*/ 2) {
    				updating_icon = true;
    				iconhandler_changes.icon = /*config*/ ctx[1].webclips[/*index*/ ctx[21]].iconurl;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(70:6) <EntryCell title=\\\"Web App Settings\\\" on:message={handleCell} cellid={index}>",
    		ctx
    	});
    ...
    // (68:3) {#each payloads as payload, index}
    function create_each_block(ctx) {
    	...
    	entrycell.$on("message", /*handleCell*/ ctx[8]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 68, 4, 2059);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(68:3) {#each payloads as payload, index}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$2, 82, 16, 2740);
    			add_location(p, file$2, 82, 3, 2727);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$2, 63, 3, 1755);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "name", "config_name");
    			attr_dev(input0, "placeholder", "Profile Name");
    			input0.required = true;
    			add_location(input0, file$2, 64, 3, 1783);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "name", "config_author");
    			attr_dev(input1, "placeholder", "Profile Author");
    			input1.required = true;
    			add_location(input1, file$2, 65, 3, 1894);
    			attr_dev(div0, "class", "formgroup");
    			add_location(div0, file$2, 62, 2, 1728);
    			attr_dev(div1, "class", "button svelte-1lwujg1");
    			add_location(div1, file$2, 76, 3, 2545);
    			add_location(br0, file$2, 77, 3, 2604);
    			add_location(br1, file$2, 77, 9, 2610);
    			attr_dev(form_1, "enctype", "multipart/form-data");
    			add_location(form_1, file$2, 61, 1, 1642);
    			add_location(main, file$2, 60, 0, 1634);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div1, "click", /*addPayload*/ ctx[7], false, false, false),
    					listen_dev(form_1, "submit", /*generate*/ ctx[2], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*handleCell, config, handleIcon, payloads*/ 354) {
    ...
    class AddApp extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { exported: 0, config: 1, generate: 2 });
    		...
    		if (/*config*/ ctx[1] === undefined && !("config" in props)) {
    			console_1$1.warn("<AddApp> was created without expected prop 'config'");
    		}
    	}
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 44, 3, 1111);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(p, "id", p_id_value = /*config*/ ctx[12].id);
    			add_location(p, file$3, 41, 4, 1054);
    			attr_dev(div, "class", "cell svelte-1syo7nm");
    			attr_dev(div, "id", div_id_value = /*config*/ ctx[12].id);
    			add_location(div, file$3, 40, 3, 994);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*openConfig*/ ctx[7], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_if_block$1(ctx) {
    	...
    	function switch_instance_generate_binding(value) {
    		/*switch_instance_generate_binding*/ ctx[8].call(null, value);
    	}

    	function switch_instance_exported_binding(value) {
    		/*switch_instance_exported_binding*/ ctx[9].call(null, value);
    	}

    	function switch_instance_config_binding(value) {
    		/*switch_instance_config_binding*/ ctx[10].call(null, value);
    	}
    	...
    	function switch_props(ctx) {
    		...
    		if (/*generate*/ ctx[1] !== void 0) {
    			switch_instance_props.generate = /*generate*/ ctx[1];
    		}

    		if (/*modaldata*/ ctx[2] !== void 0) {
    			switch_instance_props.exported = /*modaldata*/ ctx[2];
    		}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 48, 2, 1228);
    			attr_dev(div1, "class", "svelte-1syo7nm");
    			add_location(div1, file$3, 51, 4, 1342);
    			attr_dev(div2, "class", "red svelte-1syo7nm");
    			add_location(div2, file$3, 52, 4, 1408);
    			attr_dev(div3, "class", "buttons svelte-1syo7nm");
    			add_location(div3, file$3, 50, 3, 1316);
    			attr_dev(div4, "class", "modal show svelte-1syo7nm");
    			add_location(div4, file$3, 49, 2, 1288);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div0, "click", /*closeProfile*/ ctx[6], false, false, false),
    					listen_dev(
    						div1,
    						"click",
    						function () {
    							if (is_function(/*modaldata*/ ctx[2].form.requestSubmit())) /*modaldata*/ ctx[2].form.requestSubmit().apply(this, arguments);
    						},
    						false,
    						false,
    						false
    					),
    					listen_dev(div2, "click", /*closeProfile*/ ctx[6], false, false, false)
    				];
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!updating_generate && dirty & /*generate*/ 2) {
    				updating_generate = true;
    				switch_instance_changes.generate = /*generate*/ ctx[1];
    				add_flush_callback(() => updating_generate = false);
    			}

    			if (!updating_exported && dirty & /*modaldata*/ 4) {
    				updating_exported = true;
    				switch_instance_changes.exported = /*modaldata*/ ctx[2];
    ...
    function create_fragment$3(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*configs*/ ctx[4].array();
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			if (if_block) if_block.c();
    			add_location(h1, file$3, 34, 2, 817);
    			attr_dev(section0, "class", "header svelte-1syo7nm");
    			add_location(section0, file$3, 33, 1, 790);
    			attr_dev(div, "class", "button svelte-1syo7nm");
    			add_location(div, file$3, 37, 2, 865);
    			add_location(h3, file$3, 38, 2, 925);
    			attr_dev(section1, "class", "svelte-1syo7nm");
    			add_location(section1, file$3, 36, 1, 853);
    			add_location(main, file$3, 32, 0, 782);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*createProfile*/ ctx[5], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*configs, openConfig*/ 144) {
    				each_value = /*configs*/ ctx[4].array();
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function switch_instance_generate_binding(value) {
    		generate = value;
    		$$invalidate(1, generate);
    	}

    	function switch_instance_exported_binding(value) {
    		modaldata = value;
    		$$invalidate(2, modaldata);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("generate" in $$props) $$invalidate(1, generate = $$props.generate);
