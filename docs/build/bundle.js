...
<dict>
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			/*input5_binding*/ ctx[8](input5);
    			/*form_1_binding*/ ctx[9](form_1);

    			if (!mounted) {
    				dispose = [
    					listen_dev(input3, "change", /*handleIcon*/ ctx[4], false, false, false),
    					listen_dev(div1, "click", /*editIcon*/ ctx[5], false, false, false),
    					listen_dev(form_1, "submit", /*generate*/ ctx[6], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function handleIcon() {
    		...
    		reader.onload = e => {
    			$$invalidate(2, icon = e.target.result);
    		};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("dlbutton" in $$props) dlbutton = $$props.dlbutton;
    		if ("icon" in $$props) $$invalidate(2, icon = $$props.icon);
    		if ("iconel" in $$props) $$invalidate(3, iconel = $$props.iconel);
    	};
